...
public class FavoritesViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnCreateContextMenuListener {

    public TextView txtHouseName,txtHousePrice,txtHouseAddress,txtHouseBedroom,txtHouseBathroom,txtHouseSize,txtHouseDate,txtHouseCurrency;
